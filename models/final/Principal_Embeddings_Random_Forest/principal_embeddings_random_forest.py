...
n_directions_lst = [1, 2, 3, 4, 5, 6]  # second run
NLP_param_grid = {
...
grid_search_param_grid = {
    ...
    'n_estimators': [100, 300, 1000, 3000, 10000],  # second run
...
print("Saving pickle")
hf.save_pickle(optimisation_result, f'{PATH}pickle/second_300d_PE_optimisation_result')
print("Done")