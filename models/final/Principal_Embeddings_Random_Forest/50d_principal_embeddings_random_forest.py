...
filename = f'{PATH}glove/glove.6B.50d.txt.word2vec' # GloVe Common Crowl
filename_stemmed = f'{PATH}glove/stemmed_glove.6B.50d.txt.word2vec' # GloVe Common Crowl
...
n_directions_lst = [1, 2, 3, 4, 5, 6, 7, 8]  # second run
NLP_param_grid = {
...
grid_search_param_grid = {
    ...
    'n_estimators': [30, 100, 300, 1000],  # second run
...
print("Saving pickle")
hf.save_pickle(optimisation_result, f'{PATH}pickle/second_50d_PE_optimisation_result')
print("Done")